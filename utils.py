...
def get_ab3dmot_format(detection_info, autodrive=False, frame=0):
    ...
    for i, detection in enumerate(detection_info):
        if 'generated_3d_bb' in detection.keys() and detection['generated_3d_bb'] is not None:
            ...
            detection_input['confidence'] = detection['confidence']
            detection_input['frustum_pcd'] = detection['frustum_pcd']
            detection_input['object_candidate_cluster'] = detection['object_candidate_cluster']
            detection_input['closest_face_center'] = detection['closest_face_center']
            detection_input['closest_face_center_distance'] = detection['closest_face_center_distance']
...
def get_det_format(tracked_dets):
    ...
    for tracked_det in tracked_dets:
        dets.append({
            ...
            'confidence': tracked_det[17],
            'frustum_pcd': tracked_det[18],
            'object_candidate_cluster': tracked_det[19],
            'closest_face_center': tracked_det[20],
            'closest_face_center_distance': tracked_det[21],
